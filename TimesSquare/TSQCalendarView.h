...
/** Whether or not the calendar highlights a range of dates between two selected dates. If true, only two selected dates will be used. If the user attempts to select a third date, the calendar will instead attempt to move the closest selected date. Ignored if allowsMultipleSelection is NO.
 */
